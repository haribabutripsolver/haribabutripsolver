...
public class TicketBookingsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    private final int VIEW_TYPE_NORESULT = 2;
    ...
    public TicketBookingsAdapter(List<TicketBookingsResponse> tiketbookinglist,Context ctx,String bookingtype,int viewid,int loadlimit) {
