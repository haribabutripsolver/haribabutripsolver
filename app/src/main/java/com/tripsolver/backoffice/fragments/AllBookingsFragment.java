...
import com.tripsolver.backoffice.Adapters.AllTicketBookingsAdapter;
 ...
 */
public class AllBookingsFragment extends Fragment implements FragmentNavigation.MainView{
...
int activitytypeintvalue=0;
    ...
    AllTicketBookingsAdapter mAdapter;
    int loadlimit=30;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(!isapicalled)
        {
            ...
            if (status != 0) {
                callApiService(sess.getAgencyId(), "");
            }
            else
            {
                noInternetPopUp();
   ...
   filterticketbookresponse = new ArrayList<>();
        ...
        if (filterticketbookresponse != null&&filterticketbookresponse.size()>0) {
            ...
            if(filterticketbookresponse.size()<=loadlimit)
            {
             ...
             mAdapter = new AllTicketBookingsAdapter(filterticketbookresponse,getActivity(),"",R.layout.brolallbookings,loadlimit);
...
{    List<TicketBookingsResponse> tempticketbookingresponse=null;
    ...
    for (TicketBookingsResponse ticketbookingobj : ticketbookingresponse) {
        ...
        switch (ticketbookingobj.getBookingstatus())
        {

            case "Cancelled":
                ticketbookingobj.setColorvalue("#f6bcbc");
                break;
            case "confirmed":
                ticketbookingobj.setColorvalue("#fdba52");
                break;
            case "Ticketed":
                ticketbookingobj.setColorvalue("#b9eeb9");
                break;
            case "Booking Started":
                if(ticketbookingobj.getSourcetype().equals("TGDS-Process"))
                {
                    ticketbookingobj.setColorvalue("#3775dd");
                }
                else
                {
                    ticketbookingobj.setColorvalue("#e6c295");
