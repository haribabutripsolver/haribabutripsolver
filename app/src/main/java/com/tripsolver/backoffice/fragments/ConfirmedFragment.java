 ...
 */
public class ConfirmedFragment extends Fragment implements FragmentNavigation.MainView{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(!isapicalled)
        {
            ...
            if (status != 0) {
                callApiService(sess.getAgencyId(), "confirmed");
            }
            else
            {
                noInternetPopUp();
    ...
    public void callRecyclerAdapter(List<TicketBookingsResponse> ticketBookingsResponse) {
        ...
        if (filterticketbookresponse != null&&filterticketbookresponse.size()>0) {
            ...
            mAdapter = new TicketBookingsAdapter(filterticketbookresponse,getActivity(),"confirmed",R.layout.broconfirmedresult,loadlimit);
